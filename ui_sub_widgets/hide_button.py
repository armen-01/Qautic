...
class HideButton(QLabel):
    def __init__(self, parent=None):
        ...
        self.color_inactive = "#8a8a8a"
        self.color_active = "#bbb"
        ...
        self.setStyleSheet(f"color: {self.color_inactive}; background: transparent;")
        self._hover = False

    def enterEvent(self, event):
        self._hover = True
        self.setStyleSheet(f"color: {self.color_active}; background: transparent;")
